...
function PList() {
  ...
  const [qtAtual, setQtAtual] = useState("");
  ...
  const buscarAvancado = async (e) => {
    e.preventDefault();
    try {
      const params = new URLSearchParams();
      if (busca) params.append("termo", busca);
      if (categoria) params.append("categoria", categoria);
      if (qtAtual) params.append("qtAtual", qtAtual);
    ...
    <>
      <div className="sidebar">
        <ul className="side-menu">
          ...
          <li className="active"><Link to="/P_list"><i className="bx bx-receipt"></i>Estoque</Link></li>
        ...
        <main>
          <div className="cabecalho-wrapper">
            <div className="cabecalho-header">
              ...
              <p>Consulte, filtre e gerencie os produtos cadastrados</p>
            </div>

            <div className="list-container">
              <form onSubmit={buscarAvancado} className="list-form">
                <input
                  type="search"
                ...
                <input
                  ...
                  value={qtAtual}
                  onChange={(e) => setQtAtual(e.target.value)}
                />
